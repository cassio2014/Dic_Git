...
Begin VB.Form frmAddIn 
   ...
   Caption         =   "Cria uma DLL em Visual Basic"
   ClientHeight    =   3480
   ClientLeft      =   2172
   ClientTop       =   1932
   ClientWidth     =   6036
   ...
   Begin VB.Label lblDesc 
      AutoSize        =   -1  'True
      Caption         =   "Selecione as funções que serão exportadas para a DLL:"
      Height          =   192
      Index           =   0
      Left            =   240
      TabIndex        =   3
...
If strDefPath = "" Then
    MsgBox "Por Favor Salve seu Projeto antes de escolher O que exportar.", vbInformation, "Make DLLs"
    Unload Me
    Connect.Hide
    Exit Sub
End If
