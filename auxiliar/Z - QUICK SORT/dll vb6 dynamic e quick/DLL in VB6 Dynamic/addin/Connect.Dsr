...
Begin {AC0714F6-3D04-11D1-AE7D-00A0C90F26F4} Connect 
   ...
   _ExtentY        =   10769
   _Version        =   393216
   Description     =   "Agora voçê podera criar suas  DLLs no Visual Basic!"
   DisplayName     =   "Criando DLLs en  VB - Versão 2"
...
Else
    ...
    #If bolSubItems = 1 Then
        ...
        With mcbMenu
            ...
            Set mcbTemp = .Controls.Add(msoControlButton, , , , True)
            mcbTemp.Caption = "&Criar Arquivo DLL..."
    ...
    #Else
        ...
        mcbMenu2.Caption = "&Escolher Exportar..."
